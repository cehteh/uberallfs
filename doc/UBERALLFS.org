...
** The Idea
   ...
   #
   # $ uberallfs insta ./uberallfs --from uberallfs://www.pipapo.org:<port>/<base64encodedidentifier>
   #
   # root dir should only list accessible files, write only for dirs, constrained to few dir
