// Define every possible value, this allows for unsafe conversions from bytes
// values to enums with transmute without checking because this is exhaustive
// and infallible. Errors will be handled when matching. Reserved entries
// starting with an underscore and are ideas w/o any implementation yet.
